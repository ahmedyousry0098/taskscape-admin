                ...
                : <>
                    {getAllEmployees?.employees?.map((member: any) =>
                        <div
                            ...
                            <p className="font-bold py-1">Job title:<span className="font-medium ps-1">{member.title}</span></p>
                            ...
                            <p className="font-bold py-1">Employment type:<span className="font-medium ps-1">{member.employmentType}</span></p>
                            <p className="font-bold py-1">Experience:<span className="font-medium ps-1">{member.experience}</span></p>
